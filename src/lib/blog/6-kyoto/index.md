...
![Vivi and Lily on their phones on the shinkansen](./6-shinkansen.png)
![A shinkansen with the doors open](./6-shinkansen2.png)
...
![The busy area in front of Kyoto station's main gates](./6-station.png)
![A seating area with RTX on shot from an escalator above](./6-station2.png)
![A red point light illuminating the side of something on the roof](./6-station3.png)
![Lily's silhouette against a busy Kyoto street below](./6-station4.png)
![Stairs mirrored through one-way glass](./6-station5.png)
