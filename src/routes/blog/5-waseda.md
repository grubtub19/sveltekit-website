...
![A beem of light cast across a building and the ground]($lib/assets/blog/5-sky3.png)
![The street below]($lib/assets/blog/5-sky4.png)
![Looking straight down at the building's plaza]($lib/assets/blog/5-sky5.png)
...
![A silver FujiFilm X-T50 on display]($lib/assets/blog/5-camera3.png)

# Waseda

I used to live close enough to Shinjuku to walk home, so I took the same path back to my old dorm through the park :)

![The road shot from a bush]($lib/assets/blog/5-park.png)
![Barely illuminated wooden stairs]($lib/assets/blog/5-park2.png)

## Waseda Hoshien

I didn't cry guys trust me, I was really normal about it.

![The sign for Waseda Hoshien]($lib/assets/blog/5-waseda.png)
![My old dorm building]($lib/assets/blog/5-waseda2.png)

I walked around the Waseda campus and only hopped one fence for a picture.

![Val in front of a map of Waseda campus]($lib/assets/blog/5-waseda3.png)
![A liminal path lit green]($lib/assets/blog/5-waseda4.png)

There's the police building I was held in for two hours. Long story ask me about it sometime.

![A small police station on a stree corner]($lib/assets/blog/5-waseda5.png)

I got taiyaki from my favorite shop. Only 300 yen!

![POV holding taiyaki in front of the store]($lib/assets/blog/5-waseda6.png)

I got this really pretty shot of some decoration in the subway on the way home.

![A web of green tubes reflecting light from behind]($lib/assets/blog/5-pipe.png)
