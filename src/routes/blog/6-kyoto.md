...
![Vivi and Lily on their phones on the shinkansen]($lib/assets/blog/6-shinkansen.png)
![A shinkansen with the doors open]($lib/assets/blog/6-shinkansen2.png)
...
![The busy area in front of Kyoto station's main gates]($lib/assets/blog/6-station.png)
![A seating area with RTX on shot from an escalator above]($lib/assets/blog/6-station2.png)
![A red point light illuminating the side of something on the roof]($lib/assets/blog/6-station3.png)
![Lily's silhouette against a busy Kyoto street below]($lib/assets/blog/6-station4.png)
![Stairs mirrored through one-way glass]($lib/assets/blog/6-station5.png)
